...
## Atmosphere Decontamination Using Time-Domain Component Separation {style="font-size: 16pt;"}
...
## Spectral likelihood minimization {style="font-size: 18pt;"}
...
Spectral likelihood values in the $(w_x, w_y)$ plane for a fixed PWV values.
...
Proof of concept: we can recover the input values of $(w_x, w_y)$!
...
- We are building a python-based toolbox
  ...
  - interfaced with Simons Observatory products
